...
% \ifCLASSOPTIONcompsoc #GC - this was giving biblatex error
...
\usepackage{booktabs}
\usepackage{multirow}
% \usepackage[numbers,sort&compress]{natbib} #GC - this was giving biblatex error
\usepackage{dblfloatfix}

% For archive submissions follow this:
% 1. https://www.overleaf.com/learn/how-to/LaTeX_checklist_for_arXiv_submissions
% 2. git clone
% 3. remove comments

\usepackage[maxnames=2,firstinits=true,sorting=none,doi=false,url=true,isbn=false]{biblatex}
\usepackage{balance} %balance bib columns
% \addbibresource{assertion.bib}
\addbibresource{assertion.bib}
\begin{document}
\title{Safety Validation of Autonomous Vehicles using Assertion-based Oracles\\ \today}
\author{\IEEEauthorblockN{Christopher Harper, Saquib Alam\\ Severin Lemaignan and Tony Pipe}
\IEEEauthorblockA{Bristol Robotics Laboratory\\
University of the West of England, Bristol\\
Frenchay Campus, Bristol, UK \\
% BS16 XXX\\
Email: chris.harper@brl.ac.uk, \\tony.pipe@brl.ac.uk,\\ severin.lemaignan@uwe.ac.uk, \\saquib.alam@uwe.ac.uk}
\and
\IEEEauthorblockN{Greg Chance, Abanoub Ghobrial\\ and Kerstin Eder}
\IEEEauthorblockA{Trustworthy Systems Laboratory\\
University of Bristol\\
Dept. of Computer Science, Bristol, UK\\ 
% BS1 XXX\\
Email: greg.chance@bristol.ac.uk,\\ abanoub.ghobrial@bristol.ac.uk,\\ kerstin.eder@bristol.ac.uk}}
...
The paper presents some initial simulation and realtime video analysis experiments that apply assertions related to vehicle overtaking, and a brief analysis of the safety and mission performance characteristics measured. [129 words]
\end{abstract}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.98\linewidth]{SimulatorAssertionsTestBenchArchitectureV7.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.98\linewidth]{RuntimeAssertionsTestBenchArchitectureV6.pdf}
...
\begin{figure*} [h!]
    \centering
    \includegraphics[width=18cm]{DBMS_deployment.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=8.5cm]{Slide5b.jpg}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.98\linewidth]{Assertion Categories Figure.png}
...
The second waypoint is set at the transition from pull-out to passing the VBP, as shown in Figure \ref{fig:Passing_t1}. The figure shows the expressions for the distance travelled by all vehicles in the \textit{$[t_0, t_1]$} time period (taking into account aspects such as the movement of the AV into the oncoming traffic lane):
 \begin{figure}
    \centering
    \includegraphics[width=0.98\linewidth]{Passing_t1_v2.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=8.5cm]{ERD2.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=8.5cm]{carla_challenge_NHTSA_task6_LHS.jpg}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=8.5cm]{Lanelets_anno_av.png}
...
In our experiment, we developed three different variations of the Safe Distance Ahead assertion, each calculating the safe distance ahead using the formula developed from the modelling analysis (see Section \ref{model_based_analysis}), but which assumed three different driving profiles corresponding to three different levels of urgency of overtake manoeuvre (called `relaxed', `hurried' and `aggressive'). The levels of urgency were based loosely on similar concepts developed in other Human Factors research~\cite{Chen2015}, which had equated level or degree of urgency with \emph{Time To Collision} (TTC). These sources identified that a TTC of approximately two seconds corresponds approximately to a medium degree of urgency, which we have labelled `hurried'.  
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=8.5cm]{SDA_annotated.png}
...
\begin{figure*}[h]
%    \centering
    \includegraphics[width=18cm]{Overtaking_Manoeuvre_Analysis_global_view_v2.png}
