...
We use the UK Highway Code~\cite{highwayCode} (UKHC), as exemplar driving conduct and thus can be used to create validation assertions for properties such as safety and mission performance. %liveness.
...
Evaluation of AV behaviour against codes of driving conduct is emerging as an essential aspect AV verification and certification, as set out in the recent UK Law Commission report~\cite{law_commission_UK}. 
...
%
In this example the AV is on the left of the figure overtaking a parked vehicle requiring a lane change. The distance to the oncoming vehicle is termed the \emph{Distance Ahead}. 
%
...
\noindent \textbf{iv)} the AV should not enter the VBP$_{DS}$ and 

\noindent \textbf{v)} there should be no intersection between the AV$_{DS}$ and the VBP$_{DS}$. 
...
\section{Conclusion}\label{conclusion}\todo[inline]{Revise: cover contributions, ...}
