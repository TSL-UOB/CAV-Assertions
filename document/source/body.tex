...
%
Delta can be thought of as the time it would take for any oncoming vehicle to collide with the AV and is synonymous with TTC. %, and is also measured in units of time. 
...
%
% \todo{clarify delta, which is measured in seconds and corresponds to TTC}
% >>>>>>> 73dcf5c238b93d3bf13283edf1ff00e8dcb5fd58
%
...
%
The acceptable size of this \emph{opportunity window} (\textbf{gap acceptance [ref]}) will be dependent on a myriad of different contextual and preferential conditions such as the driving style, vehicle capability and passenger comfort. For example, an aggressive driving style with a tolerance for a low TTC, will be able to make use of smaller gaps in traffic than a more risk adverse driving style. 
...
% \todo{is this the Distance Ahead in Fig.\ 2?} 
