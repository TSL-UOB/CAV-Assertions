...
We focus on the UK Highway Code~\cite{highwayCode} (UKHC) as exemplar driving conduct rules that can be used to create validation assertions for properties such as safety and mission performance. %liveness.
